...
// NodesList returns the nodes in the Proxmox cluster in the given region.
func (t *ProxmoxTools) NodesList(ctx context.Context, region, authToken string) (*NodesListResult, error) {
